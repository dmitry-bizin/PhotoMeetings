...
public abstract class SettingsService {
    ...
    private static final float DEFAULT_LAT = 0F;
    private static final float DEFAULT_LNG = 0F;
    ...
    private static final float EPS_M = 50F;//метры
    ...
    public static int getRadius(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SETTINGS, Context.MODE_PRIVATE);
        return sharedPreferences.getInt(RADIUS, DEFAULT_RADIUS);
    }

    public static void saveRadius(Context context, Integer radius) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SETTINGS, Context.MODE_PRIVATE);
    ...
    public static void setDefaultSettings(Context context) {
        ...
        if (!sharedPreferences.contains(RADIUS)) {
            sharedPreferences.edit().putInt(RADIUS, DEFAULT_RADIUS).apply();
        }
    ...
    public static void saveSearch(String search, Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SETTINGS, Context.MODE_PRIVATE);
